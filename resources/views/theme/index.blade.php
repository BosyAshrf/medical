		...
		<div class="header-upper">
			<div class="inner-container clearfix">
				...
				<div class="logo-outer">
					<div class="logo"><a href="index.html"><img src="{{ asset('assets/images/logo-3.png') }}" alt="" title=""></a></div>
				</div>
					...
					<nav class="main-menu navbar-expand-md navbar-light">
						...
						<div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
								<li class="current dropdown"><a href="#">{{ trans('main-translate.Home') }}</a>
									<ul>
								...
								<li class="dropdown"><a href="#">{{trans('main-translate.About us') }}</a>
										<ul>
									...
									<li class="dropdown has-mega-menu"><a href="#">{{ trans('main-translate.Pages') }}</a>
										<div class="mega-menu">
											<div class="mega-menu-bar row clearfix">
												...
												<div class="column col-md-3 col-xs-12">
													<h3>Doctors</h3>
													<ul>
														<li><a href="doctors.html">{{ trans('main-translate.Doctors') }}</a></li>
								...
								<li class="dropdown"><a href="#">{{ trans('main-translate.Doctors') }}</a>
									<ul>
										<li><a href="doctors.html">Doctors</a></li>
										<li><a href="doctors-detail.html">Doctors Detail</a></li>
									</ul>
								</li>
								<li class="dropdown"><a href="#">{{ trans('main-translate.Department') }}</a>
									<ul>
										<li><a href="department.html">Department</a></li>
										<li><a href="department-detail.html">Department Detail</a></li>
									</ul>
								</li>
								<li class="dropdown"><a href="#">{{ trans('main-translate.Blog') }}</a>
									<ul>
										<li><a href="blog.html">Our Blog</a></li>
										<li><a href="blog-classic.html">Blog Classic</a></li>
										<li><a href="blog-detail.html">Blog Detail</a></li>
								...
								<li class="dropdown"><a href="#">{{ trans('main-translate.Shops') }}</a>
										<ul>
											<li><a href="shop.html">Shop</a></li>
											<li><a href="shop-single.html">Shop Details</a></li>
											<li><a href="shoping-cart.html">Cart Page</a></li>
								...
								<li><a href="contact.html">{{ trans('main-translate.Contact') }}</a></li>
							</ul>
